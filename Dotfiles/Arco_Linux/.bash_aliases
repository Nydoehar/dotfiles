...
alias conf='cd /mnt/HDD/MY_STUFF/TECH/Configs/ && c'
alias scri='cd /mnt/HDD/MY_STUFF/TECH/Configs/Scripts && c'
alias dot='cd /mnt/HDD/MY_STUFF/TECH/Configs/Dotfiles && c'
...
alias awebdev='(xargs brave < /mnt/HDD/MY_STUFF/TECH/Configs/Scripts/a.webdev.txt && c)'
alias abrave='(xargs brave < /mnt/HDD/MY_STUFF/TECH/Configs/Scripts/a.URLs.txt &>/dev/null && c)'
